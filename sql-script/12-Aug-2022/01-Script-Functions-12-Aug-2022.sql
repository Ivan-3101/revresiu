...
CREATE OR REPLACE FUNCTION ui.getlivetrans_last(
...
Return query select l.iLiveMessageID as "ID", l.vcmsgid as "Unique ID", l.dtTrxnTime at time zone 'utc' at time zone timezone as "Time",
                    ...
                    l.vcpayeraccount, l.vcpayeeaccount from transactions.vw_livetrans_with_vpa_and_account_from_joins l where  txnclass = classname
                                                                                                                          and l.score >= riskscore
             order by dtTrxnTime desc limit maxrecord;

else
Return query select l.iLiveMessageID as "ID", l.vcmsgid as "Unique ID", l.dtTrxnTime at time zone 'utc' at time zone timezone as "Time",
                    l.payervpa, l.payername, l.payeevpa, l.payeename, l.dTransAmount as "Amount", l.bFRMPassed as "FRM Pass", l.score as "Score", l.vcrulename as "Rule",
                    l.vcpayeraccount, l.vcpayeeaccount from transactions.vw_livetrans_with_vpa_and_account_from_joins l where l.score >= riskscore
             order by dtTrxnTime desc limit maxrecord;
...
CREATE OR REPLACE FUNCTION ui.getlivetrans_autorefresh(
	ilivemsgid bigint,
	classname character varying,
	riskscore integer,
	timezone character varying)
...
Return query select l.iLiveMessageID as "ID", l.vcmsgid as "Unique ID", l.dtTrxnTime at time zone 'utc' at time zone timezone as "Time",
                    l.payervpa, l.payername, l.payeevpa, l.payeename, l.dTransAmount as "Amount", l.bFRMPassed as "FRM Pass", l.score as "Score", l.vcrulename as "Rule",
                    l.vcpayeraccount, l.vcpayeeaccount from transactions.vw_livetrans_with_vpa_and_account_from_joins l where  txnclass = classname
                                                                                                                          and l.score >= riskscore and l.iLiveMessageID > ilivemsgid
             order by dtTrxnTime desc ;

else
Return query select l.iLiveMessageID as "ID", l.vcmsgid as "Unique ID", l.dtTrxnTime at time zone 'utc' at time zone timezone as "Time",
                    l.payervpa, l.payername, l.payeevpa, l.payeename, l.dTransAmount as "Amount", l.bFRMPassed as "FRM Pass", l.score as "Score", l.vcrulename as "Rule",
                    l.vcpayeraccount, l.vcpayeeaccount from transactions.vw_livetrans_with_vpa_and_account_from_joins l where l.score >= riskscore and l.iLiveMessageID > ilivemsgid
             order by dtTrxnTime desc ;
