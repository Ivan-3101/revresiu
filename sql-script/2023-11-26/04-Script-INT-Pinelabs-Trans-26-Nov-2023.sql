...
manual_attribs = '{"display":[
  ...
  },
  {
    ...
    "onClickAction": [
      {
        "key": "callApi",
        "url": "/api/v1/case-management/tasks/workflows/manual-creation/get-realtime-trans/${address}/${level}/${txnid}/${workflow}",
        "headers": [
          {
            "name": "JWT"
          }
...
"type":"realtime-multitrans"}'::jsonb WHERE
workflowid = 16;
update ui.workflowmasters set is_manual_creation=true where workflowid=16;
UPDATE ui.workflowmasters SET manualworkflowid = '16'::integer WHERE workflowid = 16;