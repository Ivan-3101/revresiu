  ...
  "display": [
    {
      ...
      "onChangeAction": [
        {
          "key": "callApi",
          "url": "/api/v1/case-management/tasks/workflows/manual-creation/profile-dates/${address}/${level}/${frequency}/${workflow}",
          "headers": [
            {
              "name": "JWT"
            }
    ...
    },
    {
      ...
      "onClickAction": [
        {
          "key": "callApi",
          "url": "/api/v1/case-management/tasks/workflows/manual-creation/get-batch-trans/${address}/${level}/${frequency}/${date}/${workflow}",
          "headers": [
            {
              "name": "JWT"
            }
