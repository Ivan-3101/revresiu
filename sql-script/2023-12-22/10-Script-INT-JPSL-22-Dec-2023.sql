...
<p>Greetings from Jio Payment Solutions Ltd.</p> 
<p>Jio Payment Solutions Ltd has always worked to maintain a trusted environment and safeguard merchant partners from fraudulent transactions. We wish to inform you that as per the Jio Payment Solutions Ltd'' Transaction Monitoring System, the following transactions were found to be inconsistent. These transactions are being further review.</p> 
...
<p><span th:text="${emailnote}"></p> 
<p>Thank you,<p>
<p>Team Jio Payment Solutions Ltd</p> '::text WHERE
id = 27;

UPDATE ui.emailtemplate SET
body =  E'<p>Dear Merchant Partner, </p>
Greetings from Jio Payment Solutions Ltd. 
Jio Payment Solutions Ltd has always worked to maintain a trusted environment and safeguard merchant partners from fraudulent transactions. We wish to inform you that as per the Jio Payment Solutions Ltd'' Transaction Monitoring System, the following transactions were found to be inconsistent. These transactions are being put on hold till further review. 
...
<p>Please note that the Jio Payment Solutions Ltd team will review the documents, and the payment will be released once the documents are deemed valid.</p>
<p>We regret the inconvenience caused and appreciate your cooperation in this regard.</p>
<p>Please contact us at 0120-4033600 or write to <span th:text="${emailid}"></span> for any further assistance.</p>
<p><span th:text="${emailnote}"></p>
<p>Thank you,<p>
