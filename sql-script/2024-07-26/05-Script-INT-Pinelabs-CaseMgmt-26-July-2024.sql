  ...
  },
  {
    ...
    "options": [
      ...
      },
      {
        ...
        "value": {
          "config": {
            "my": "_arrayofobjects,Action2,eq,parameters.orQueries[].processVariables,hold_settlement_all_transaction,hold_current_transaction,hold_current_transaction_blacklist,hold_settlement_all_transaction_blacklist,select_and_hold_transaction_blacklist,add_transactions_to_hold_in_current_case",
            "open": "_arrayofobjects,Action2,eq,parameters.orQueries[].processVariables,hold_settlement_all_transaction,hold_current_transaction,hold_current_transaction_blacklist,hold_settlement_all_transaction_blacklist,select_and_hold_transaction_blacklist,add_transactions_to_hold_in_current_case",
            "closed": "_arrayofobjects,Action2,eq,parameters.orQueries[].variables,hold_settlement_all_transaction,hold_current_transaction,hold_current_transaction_blacklist,hold_settlement_all_transaction_blacklist,select_and_hold_transaction_blacklist,add_transactions_to_hold_in_current_case",
            "myclosed": "_arrayofobjects,Action2,eq,parameters.orQueries[].processVariables,hold_settlement_all_transaction,hold_current_transaction,hold_current_transaction_blacklist,hold_settlement_all_transaction_blacklist,select_and_hold_transaction_blacklist,add_transactions_to_hold_in_current_case"
          },
          "arrayofobjects": true
        }
      }
