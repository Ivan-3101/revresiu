delete from ui.rolemenuaccessmap where iroleid=5 and imenuid= (select imenuid from ui.menustructuredesc where  vcaction ='Admin') and itenantid in (17, 21, 23,8,16,22);
