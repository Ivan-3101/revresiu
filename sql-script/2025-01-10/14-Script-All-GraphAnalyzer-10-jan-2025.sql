...
ALTER FUNCTION masters.get_nodewithvcattribs(text, text[], text, text, integer)
    OWNER TO dronapay;


UPDATE ui.dashboardquery SET
vcdashboardquery = 'SELECT * FROM masters.get_nodewithvcattribs(:Party, ARRAY[:SearchField], :VpaAddress, :DisplayField, :tenantid)
'::text WHERE
idashboardqueryid in (120,148);