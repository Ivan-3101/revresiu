...
'78'::integer, true::boolean, false::boolean, 'Master Extracts-DL'::character varying, '17'::integer, '1'::integer, '510'::integer, '17'::integer, true::boolean)
...
}'::text, false::boolean, false::boolean, false::boolean, '510'::integer, '17'::integer, '3'::integer)
...
'237'::integer, '{"sizes":[1],"detail":{"main":{"type":"tab-area","widgets":["PERSPECTIVE_GENERATED_ID_1"],
...
"filter":[],"sort":[],"expressions":[],"aggregates":{},"master":false,"table":"masterextracts","linked":false}}}'::text, 'masterextracts'::character varying, '164'::integer, '78'::integer, '1'::integer, '510'::integer, '17'::integer, '5'::integer)
...
(SELECT max(idashboardfilterid)+1 FROM ui.dashboardfilters), '4'::integer, 'AttribsForm'::character varying, '78'::integer, 'FormFilter'::character varying, '74'::integer, '17'::integer, 'Attribs Form Filter'::character varying)
...
(SELECT max(idashboardfilterid)+1 FROM ui.dashboardfilters), '3'::integer, 'Transpose'::character varying, '78'::integer, 'Transpose'::character varying, '17'::integer, 'Transpose'::character varying)
returning idashboardfilterid,itenantid;
INSERT INTO ui.dashboardfilters (
idashboardfilterid, ifilterorder, vcdashboardfiltername, idashboardid, vcdashboardfiltertype, idashboardqueryidforoptions, itenantid, vcdashboardfilterdisplayname) VALUES (
(SELECT max(idashboardfilterid)+1 FROM ui.dashboardfilters), '2'::integer, 'Load'::character varying, '78'::integer, 'Select'::character varying, '91'::integer, '17'::integer, 'Load'::character varying)
returning idashboardfilterid,itenantid;
INSERT INTO ui.dashboardfilters (
...
(SELECT max(idashboardfilterid)+1 FROM ui.dashboardfilters), '1'::integer, 'DateRange'::character varying, '78'::integer, 'DateRangePicker'::character varying, '16'::integer, '17'::integer, 'Date Range'::character varying)
returning idashboardfilterid,itenantid;
INSERT INTO ui.dashboardfilters (
idashboardfilterid, ifilterorder, vcdashboardfiltername, idashboardid, vcdashboardfiltertype, idashboardqueryidforoptions, itenantid, vcdashboardfilterdisplayname) VALUES (
(SELECT max(idashboardfilterid)+1 FROM ui.dashboardfilters), '0'::integer, 'Party'::character varying, '78'::integer, 'Select'::character varying, '67'::integer, '17'::integer, 'Level'::character varying)
returning idashboardfilterid,itenantid;
...
(SELECT max(idashboardparameterid)+1 FROM ui.dashboardqueryparameters), 'DateRange'::character varying, 'DateRange'::character varying, '164'::integer, '17'::integer)
returning idashboardparameterid,itenantid;
INSERT INTO ui.dashboardqueryparameters (
idashboardparameterid, vcparametername, vcparametertype, idashboardqueryid, itenantid) VALUES (
(SELECT max(idashboardparameterid)+1 FROM ui.dashboardqueryparameters), 'Load'::character varying, 'Integer'::character varying, '164'::integer, '17'::integer)
returning idashboardparameterid,itenantid;
INSERT INTO ui.dashboardqueryparameters (
idashboardparameterid, vcparametername, vcparametertype, idashboardqueryid, iorder, itenantid) VALUES (
(SELECT max(idashboardparameterid)+1 FROM ui.dashboardqueryparameters), 'Party'::character varying, 'JsonPath'::character varying, '164'::integer, '1'::integer, '17'::integer)
returning idashboardparameterid,itenantid;
INSERT INTO ui.dashboardqueryparameters (
idashboardparameterid, vcparametername, vcparametertype, idashboardqueryid, iorder, itenantid) VALUES (
(SELECT max(idashboardparameterid)+1 FROM ui.dashboardqueryparameters), 'Transpose'::character varying, 'JsonPath'::character varying, '164'::integer, '0'::integer, '17'::integer)
returning idashboardparameterid,itenantid;
INSERT INTO ui.dashboardqueryparameters (
idashboardparameterid, vcparametername, vcparametertype, idashboardqueryid, itenantid) VALUES (
(SELECT max(idashboardparameterid)+1 FROM ui.dashboardqueryparameters), 'AttribsForm'::character varying, 'WhereStatement'::character varying, '164'::integer, '17'::integer)
returning idashboardparameterid,itenantid;
