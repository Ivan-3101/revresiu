  ...
  },
  {
    ...
    "options": [
      ...
      },
      {
        ...
        "value": {
          "config": {
            "my": ["_arrayofobjects,Action2,like,parameters.processVariables[],%release%"],
            "open": ["_arrayofobjects,Action2,like,parameters.processVariables[],%release%"],
            "closed": ["_arrayofobjects,Action2,like,parameters.variables[],release%"],
            "myclosed": ["_arrayofobjects,Action2,like,parameters.processVariables[],%release%"]
          },
          "arrayofobjects": true
        }
      }
