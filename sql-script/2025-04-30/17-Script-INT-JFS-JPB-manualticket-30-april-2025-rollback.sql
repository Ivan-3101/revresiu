...
manual_attribs ->> 'type' = 'realtime-multitrans'


UPDATE ui.dashboardqueryparameters SET
vcparametertype = 'String'::character varying WHERE
idashboardqueryid = 170 and itenantid= 12 and vcparametername='address';
...
delete from ui.dashboardqueryparameters  WHERE
idashboardqueryid = 170 and itenantid= 12 and vcparametername='DateRange';
