-- rule efficeincy report

INSERT INTO ui.dashboard VALUES (75, true, false, 'Rule Efficiency Report - DL', 6, 1, 510, 21, true);


INSERT INTO ui.dashboardfilters VALUES ((SELECT max(idashboardfilterid)+1 FROM ui.dashboardfilters), 0, 'DateRange', 75, 'DateRangePicker', 32, NULL, 21, 'Date Range');
...
LIMIT 10000', false, true, NULL, 510, 21, 3);

INSERT INTO ui.dashboardqueryparameters VALUES ((SELECT max(idashboardparameterid)+1 FROM ui.dashboardqueryparameters), 'DateRange', 'DateRange', 161, NULL, 21);
...
INSERT INTO ui.dashboard VALUES (75, true, false, 'Rule Efficiency Report - DL', 6, 1, 510, 22, true);


INSERT INTO ui.dashboardfilters VALUES ((SELECT max(idashboardfilterid)+1 FROM ui.dashboardfilters), 0, 'DateRange', 75, 'DateRangePicker', 32, NULL, 22, 'Date Range');
...
AND rp.score > 0 
AND rp.itenantid = :tenantid 
LIMIT 10000', false, true, NULL, 510, 22, 3);

INSERT INTO ui.dashboardqueryparameters VALUES ((SELECT max(idashboardparameterid)+1 FROM ui.dashboardqueryparameters), 'DateRange', 'DateRange', 161, NULL, 22);
...
INSERT INTO ui.dashboard VALUES (75, true, false, 'Rule Efficiency Report - DL', 6, 1, 510, 8, true);


INSERT INTO ui.dashboardfilters VALUES ((SELECT max(idashboardfilterid)+1 FROM ui.dashboardfilters), 0, 'DateRange', 75, 'DateRangePicker', 32, NULL, 8, 'Date Range');
...
AND rp.score > 0 
AND rp.itenantid = :tenantid 
LIMIT 10000', false, true, NULL, 510, 8, 3);

INSERT INTO ui.dashboardqueryparameters VALUES ((SELECT max(idashboardparameterid)+1 FROM ui.dashboardqueryparameters), 'DateRange', 'DateRange', 161, NULL, 8);
...
vcdashboardquery = 'SELECT
    ...
    rp.accounts_affected AS "Unique Accounts Triggered",
    rp.vpas_affected AS "Unique VPAs Affected"
FROM t17refined.analytics.rule_performance rp
...
idashboardqueryid = 161 AND itenantid in (17, 22, 21, 8);