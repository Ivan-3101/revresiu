...
INSERT INTO ui.dashboard_17 VALUES (75, true, false, 'Rule Efficiency Report - DL', 6, 1, 510, 17, true);


INSERT INTO ui.dashboardfilters_17 VALUES ((SELECT max(idashboardfilterid)+1 FROM ui.dashboardfilters), 0, 'DateRange', 75, 'DateRangePicker', 32, NULL, 17, 'Date Range');


 INSERT INTO ui.dashboardquery_17 VALUES (161, true, '{"DateRange" : null}', 'SELECT 
    rp.tdate AS "Date", 
...
idashboardqueryid = 161 AND itenantid in (17);