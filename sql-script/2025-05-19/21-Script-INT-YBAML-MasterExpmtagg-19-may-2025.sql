...
vcdashboardquery =  E'{
    "Transpose": {
        "Customer": "SELECT attribute, data FROM t21refined.masters.customers, UNNEST(ARRAY[ROW(''Customer ID'', CAST(icustomerid AS VARCHAR)), ROW(''External Cust ID'', vcexternalcustid), ROW(''Customer Name'', vccustomername), ROW(''Onboarded On'', CAST(dtonboardingdate AS VARCHAR)), ROW(''MCC'', CAST(imcc AS VARCHAR)), ROW(''Registered mobile'', vcregisteredmobile), ROW(''Entry Date Time'', CAST(dtentrydatetime AS VARCHAR)), ROW(''Country Code'', CAST(vccountrycode AS VARCHAR)), ROW(''Customer Type'', CAST(vccustomertype AS VARCHAR)), ROW(''Email Id'', CAST(vcemail AS VARCHAR)), ROW(''record status'', CAST(irecordstatus AS VARCHAR))]) AS t(attribute, data) WHERE itenantid = :tenantid :AttribsForm AND dtentrydatetime BETWEEN CAST(:StartDate AS TIMESTAMP(6)) AND CAST(:EndDate AS TIMESTAMP(6)) ORDER BY icustomerid DESC LIMIT :Load ",
        "Account": "SELECT attribute, data FROM t21refined.masters.accounts, UNNEST(ARRAY[ROW(''Account ID'', CAST(iaccountid AS VARCHAR)), ROW(''Customer ID'', CAST(icustomerid AS VARCHAR)), ROW(''external account id'', vcexternalaccountid), ROW(''bmerchant'', CAST(bmerchant AS VARCHAR)), ROW(''record status'', CAST(irecordstatus AS VARCHAR)), ROW(''MCC'', CAST(imcc AS VARCHAR)),ROW(''IFSC'', CAST(vcifsc AS VARCHAR)),ROW(''Account Name'', CAST(vcaccountname AS VARCHAR)), ROW(''Onboarded On'', CAST(dtonboardingdate AS VARCHAR)),  ROW(''entry date time'', CAST(dtentrydatetime AS VARCHAR))]) AS t(attribute, data) WHERE itenantid = :tenantid :AttribsForm AND dtentrydatetime BETWEEN CAST(:StartDate AS TIMESTAMP(6)) AND CAST(:EndDate AS TIMESTAMP(6)) ORDER BY iaccountid DESC LIMIT :Load ",
        "VPA": "SELECT attribute, data FROM t21refined.masters.vpa, UNNEST(ARRAY[ROW(''vpa id'', CAST(ivpaid AS VARCHAR)), ROW(''account id'', CAST(iaccountid AS VARCHAR)), ROW(''external address id'', vcexternaladdressid), ROW(''Payment Address'', vcaddress), ROW(''VPA Name'', vcvpaname), ROW(''MCC'', CAST(imcc AS VARCHAR)), ROW(''Merchant'', CAST(bmerchant AS VARCHAR)), ROW(''entry date time'', CAST(dtentrydatetime AS VARCHAR)), ROW(''Verified'', CAST(bverified AS VARCHAR)), ROW(''Onboarded On'', CAST(dtonboardingdate AS VARCHAR)), ROW(''record status'', CAST(irecordstatus AS VARCHAR))]) AS t(attribute, data) WHERE itenantid = :tenantid :AttribsForm AND dtentrydatetime BETWEEN CAST(:StartDate AS TIMESTAMP(6)) AND CAST(:EndDate AS TIMESTAMP(6)) ORDER BY ivpaid DESC LIMIT :Load "
    },
    "Normal": {
        "Customer": "SELECT icustomerid AS \\"Customer ID\\", vcexternalcustid AS \\"External Cust ID\\", vccustomername AS \\"Customer Name\\", dtonboardingdate AS \\"Onboarded On\\", imcc AS \\"MCC\\", vcregisteredmobile AS \\"Mobile Number\\", irecordstatus AS \\"Record Status\\",vccustomertype AS \\"Customer Type\\", vccountrycode AS \\"Country Code\\", dtentrydatetime AS \\"Entry Date Time\\", vcemail AS \\"Email Id\\" FROM t21refined.masters.customers WHERE itenantid = :tenantid :AttribsForm AND dtentrydatetime BETWEEN CAST(:StartDate AS TIMESTAMP(6)) AND CAST(:EndDate AS TIMESTAMP(6))  ORDER BY icustomerid DESC LIMIT :Load",
        "Account": "SELECT iaccountid AS \\"Account ID\\", icustomerid AS \\"Customer ID\\", vcexternalaccountid AS \\"External Account ID\\", bmerchant AS \\"Merchant\\", irecordstatus AS \\"Record Status\\", dtentrydatetime AS \\"Entry Date Time\\", vcaccountname AS \\"Account Name\\", dtonboardingdate AS \\"Onboarded On\\", imcc AS \\"MCC\\" FROM t21refined.masters.accounts WHERE itenantid = :tenantid :AttribsForm AND dtentrydatetime BETWEEN CAST(:StartDate AS TIMESTAMP(6)) AND CAST(:EndDate AS TIMESTAMP(6)) ORDER BY iaccountid DESC LIMIT :Load",
        "VPA": "SELECT ivpaid AS \\"VPA ID\\", iaccountid AS \\"Account ID\\", vcexternaladdressid AS \\"External Address ID\\", vcaddress AS \\"Payment Address\\", vcvpaname AS \\"VPA Name\\", imcc AS \\"MCC\\", bmerchant AS \\"Merchant\\", dtentrydatetime AS \\"Entry Date Time\\", irecordstatus AS \\"Record Status\\", dtonboardingdate AS \\"Onboarded On\\", bverified AS \\"Verified\\" FROM t21refined.masters.vpa WHERE itenantid = :tenantid :AttribsForm AND dtentrydatetime BETWEEN CAST(:StartDate AS TIMESTAMP(6)) AND CAST(:EndDate AS TIMESTAMP(6))  ORDER BY ivpaid DESC LIMIT :Load"
    }
}'::text WHERE
