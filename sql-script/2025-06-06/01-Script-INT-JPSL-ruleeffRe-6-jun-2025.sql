...
INSERT INTO ui.dashboard VALUES (75, true, false, 'Rule Efficiency Report - DL', 6, 1, 510, 14, true);


INSERT INTO ui.dashboardfilters VALUES ((SELECT max(idashboardfilterid)+1 FROM ui.dashboardfilters), 0, 'DateRange', 75, 'DateRangePicker', 32, NULL, 14, 'Date Range');
...
LIMIT 10000', false, true, NULL, 510, 14, 3);

INSERT INTO ui.dashboardqueryparameters VALUES ((SELECT max(idashboardparameterid)+1 FROM ui.dashboardqueryparameters), 'DateRange', 'DateRange', 161, NULL, 14);
...
vcdashboardquery = 'SELECT
    ...
    rp.accounts_affected AS "Unique Accounts Triggered",
    rp.vpas_affected AS "Unique VPAs Affected"
FROM t14refined.analytics.rule_performance rp
...
idashboardqueryid = 161 AND itenantid in (14);
