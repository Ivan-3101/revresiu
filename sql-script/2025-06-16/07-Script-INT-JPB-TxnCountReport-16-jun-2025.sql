...
'82'::integer, true::boolean, false::boolean, 'Txn Count Report - DL'::character varying, '10'::integer, '1'::integer, '577'::integer, '12'::integer, true::boolean)
...
"Class" limit 10000;'::text, false::boolean, true::boolean, false::boolean, '577'::integer, '12'::integer, '3'::integer)
...
'::text, 'transaction'::character varying, '174'::integer, '82'::integer, '{"Date":"date", "Class":"string", "Txn Requests Received":"integer","Txns Failed to Process":"integer","Txns Processed Successfully":"integer" }'::text, '1'::integer, '577'::integer, '12'::integer, '5'::integer)
...
( SELECT max(idashboardparameterid) + 1 FROM ui.dashboardqueryparameters), 'DateRange'::character varying, 'DateRange'::character varying, '174'::integer, '12'::integer)
...
(SELECT max(idashboardfilterid)+1 FROM ui.dashboardfilters), '0'::integer, 'DateRange'::character varying, '82'::integer, 'DateRangePicker'::character varying, '79'::integer, '12'::integer, 'Date Range'::character varying)
...
optimized_trans AS (
    SELECT 
        ...
        CASE 
            ...
            ELSE 1 
        END AS "Txns Processed Successfully"
    FROM t12refined.analytics.trans tx
...
idashboardqueryid = 174 AND itenantid = 12;
