...
'83'::integer, true::boolean, false::boolean, 'Audit Report - Activity Log DL'::character varying, '33'::integer, '1'::integer, '577'::integer, '12'::integer, true::boolean)
...
}'::text, '1'::integer, '577'::integer, '12'::integer)
...
( SELECT max(idashboardparameterid) +1 FROM ui.dashboardqueryparameters) ,'DateRange'::character varying, 'DateRange'::character varying, '175'::integer, '12'::integer)
...
(SELECT max(idashboardfilterid)+1 FROM ui.dashboardfilters), '0'::integer, 'DateRange'::character varying, '83'::integer, 'DateRangePicker'::character varying, '79'::integer, '12'::integer, 'Date Range'::character varying)
...
idashboardqueryid = 175 AND itenantid = 12;
