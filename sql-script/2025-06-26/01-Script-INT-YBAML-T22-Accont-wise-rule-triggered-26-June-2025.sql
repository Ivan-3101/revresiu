CREATE view t17refined.analytics.combined_rule_triggered  AS
SELECT
...
FROM
    t17refined.analytics.batch_rule_triggered t
UNION ALL
SELECT
...
FROM
    t17refined.analytics.rule_triggered rt;



CREATE view t21refined.analytics.combined_rule_triggered  AS
SELECT
    t.dttrxntime AS "Txn Date Time",
    t.vcmsgid AS "Unique ID",
    CAST(NULL AS VARCHAR) AS "Txn ID",
    ...
    t.itenantid AS "Tenant ID"
FROM
    t21refined.analytics.batch_rule_triggered t
UNION ALL
SELECT
    rt.dttrxntime AS "Txn Date Time",
    rt.vcmsgid AS "Unique ID",
    ...
    rt.itenantid AS "Tenant ID"
FROM
    t21refined.analytics.rule_triggered rt;

CREATE view t22refined.analytics.combined_rule_triggered  AS
SELECT
    t.dttrxntime AS "Txn Date Time",
    t.vcmsgid AS "Unique ID",
    CAST(NULL AS VARCHAR) AS "Txn ID",
    ...
    t.itenantid AS "Tenant ID"
FROM
    t22refined.analytics.batch_rule_triggered t
UNION ALL
SELECT
    rt.dttrxntime AS "Txn Date Time",
    rt.vcmsgid AS "Unique ID",
    ...
    rt.itenantid AS "Tenant ID"
FROM
    t22refined.analytics.rule_triggered rt;