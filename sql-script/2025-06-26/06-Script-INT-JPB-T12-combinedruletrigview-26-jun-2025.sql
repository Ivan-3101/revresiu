...
CREATE VIEW t12refined.analytics.combined_rule_triggered SECURITY DEFINER AS
SELECT
...
FROM
  t12refined.analytics.batch_rule_triggered t
UNION ALL SELECT
...
FROM
  t12refined.analytics.rule_triggered rt;