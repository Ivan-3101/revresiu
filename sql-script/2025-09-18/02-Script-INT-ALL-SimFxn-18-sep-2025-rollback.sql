...
ALTER FUNCTION sim.analyze_sim(bigint, character varying, timestamp without time zone, timestamp without time zone, character varying, character varying, bigint, integer)
    OWNER TO dronapay;
