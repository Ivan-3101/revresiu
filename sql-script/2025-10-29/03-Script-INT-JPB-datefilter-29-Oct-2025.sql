SELECT * FROM ui.workflowmasters WHERE itenantid=12 AND workflowkey='JPB_RiskNotification';
...
displayconfig =  E'[
  ...
  },
  {
    "key": {
      ...
      "closed": {
        "key": "parameters.startedAfter,parameters.finishedBefore",
        "lodashKey": "data.formData.startDate,data.formData.endDate"
      },
      "myclosed": {
        "key": "parameters.startedAfter,parameters.finishedBefore",
    ...
    "name": "startDate,endDate,startedAfter,finishedBefore",
    "type": "dateRange",
    "label": "Date Range",
    "valueKey": "dataRangeValueKey",
    "bodyValue": {
      "key": "startDate,endDate,startedAfter,finishedBefore",
