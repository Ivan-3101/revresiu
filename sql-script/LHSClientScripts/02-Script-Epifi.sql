...
INSERT INTO ui.tasklhsmap(iorder,irow,idropdownoptionid,iworkflowid,icolumn,valueconfig) VALUES (1,0,3,2,6,'{"tag": "span", "path": "this.startTime", "type": "timestamp"}');
...
INSERT INTO ui.tasklhsmap(iorder,irow,idropdownoptionid,iworkflowid,icolumn,valueconfig) VALUES (1,0,3,1,6,'{"tag": "span", "path": "this.startTime", "type": "timestamp"}');