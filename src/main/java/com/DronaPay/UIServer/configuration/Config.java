...
public class Config implements WebMvcConfigurer {
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        ...
        registry.addResourceHandler("", "/", "/**", "/dronaui", "/dronaui/", "/dronaui/**")
                .addResourceLocations("classpath:/static/")
                .setCacheControl(CacheControl.noCache().mustRevalidate()) // ✅ add this
                .resourceChain(true)
    ...
    public class ReactResourceResolver implements ResourceResolver {
        ...
        private List<String> rootStaticFiles = Arrays.asList("favicon.png",
