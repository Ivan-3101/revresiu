...
@Entity
@Table(name = "rulesavailableaudit", schema = "ui")
@Data
public class RulesAvailableUiAudit {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "iruleavailableauditid", nullable = false)
    private Integer iRuleAvailableAuditID;
