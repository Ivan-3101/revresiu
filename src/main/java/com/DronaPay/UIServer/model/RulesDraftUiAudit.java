...
@Entity
@Table(name = "rulesdraftaudit", schema = "ui")
@Data
public class RulesDraftUiAudit {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "iruledraftauditid", nullable = false)
    private Integer iRuleDraftAuditID;
...
//    private Decisions iDecisionID;
    ...
    @OneToOne(fetch = FetchType.EAGER, cascade = CascadeType.MERGE)
    @JoinColumn(name = "iruledraftid")
    private RulesDraftUi iRuleDraftID;
